...
include 'dbcon.php';
  ...
  if(isset($_POST['submit'])){
    ...
    // $img= mysqli_real_escape_string($con,$_POST['filename']);
    $gender= mysqli_real_escape_string($con,$_POST['gender']);
    $selectitem= mysqli_real_escape_string($con,$_POST['selectitem']);
    ...
    if($emailcount>0){
      ...
      if($password === $cpassword){
        $insertquery = "insert into reg(fname,lname,email,password,cpassword,gender,selectitem) values('$fname','$lname','$email','$pass',' $cpass','$gender',' $selectitem')";
        ...
        if($iquery)
        {
          ...
          ?>
          <script>
            alert("No Data Insert Successful");
          </script>
          <?php
        }
      }else{
